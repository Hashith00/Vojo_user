                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Container(
                              child: Center(
                                child: Text("${_model.yourNameController.text[0]}", style: TextStyle(fontFamily: primaryFontFamilty, fontSize: 40, fontWeight: FontWeight.w600),),
                              ),
                            ),
                          ),
                        ),
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update(createUsersRecordData(
                        ...
                        address: _model.myBioController.text,
