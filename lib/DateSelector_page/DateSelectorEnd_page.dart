...
class DateSelectorEnd extends StatefulWidget {
  const DateSelectorEnd({super.key, required this.id});
  final String id;

  @override
  State<DateSelectorEnd> createState() => _DateSelectorEndState();
}

class _DateSelectorEndState extends State<DateSelectorEnd> {
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text("Set Ending Date", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w600),),),
                    ),
                  ),
                  GestureDetector(
                    onTap: ()async{
