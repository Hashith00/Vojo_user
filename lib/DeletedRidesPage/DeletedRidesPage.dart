...
class DeletedRidesPage extends StatefulWidget {
  const DeletedRidesPage({super.key});

  @override
  State<DeletedRidesPage> createState() => _DeletedRidesPageState();
}

class _DeletedRidesPageState extends State<DeletedRidesPage> {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                      ...
                      child: Text("Deletion Pending", style: TextStyle(fontSize: 25, fontWeight: FontWeight.w500, fontFamily: primaryFontFamilty),)),
                      ...
                      if (snapshot.hasData) {
                        ...
                        for (var message in messages) {
                          ...
                          if (tripData["is_confirmed"] == false &&
                              (tripData['user_id'] ==
                                  _auth.currentUser?.uid) && tripData["Remove_Trip_by_Admin"] == false) {
                            rides.add(tripCard);
                          }
                        }
